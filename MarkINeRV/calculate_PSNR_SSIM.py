...
REV = '\\HiNet-main\\HiNet-main\\image\\secret'


def main():
    # Configurations

    # GT - Ground-truth;#真值、真实的有效值或者是标准的答案
    # Gen: Generated / Restored / Recovered images
    folder_GT = '\\HiNet-main\\HiNet-main\\image\\secret-rev'
    folder_Gen = REV
    crop_border = 1
    ...
    img_list = natsorted(img_list)#自然排序
