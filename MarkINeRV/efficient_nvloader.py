...
def main():
    ...
    parser.add_argument('--decoder', type=str, default='checkpoints/5/img_decoder.pth', help='path for video decoder',)#生成改这里的
    parser.add_argument('--ckt', type=str, default='checkpoints/5/quant_vid.pth', help='path for video checkpoint',) #生成改这里的
    parser.add_argument('--dump_dir', type=str, default='visualize/5_1.5M_E300', help='path for video checkpoint',) #生成改这里的
